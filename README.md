...
| 생성 규모 | 사용자 10명, 게시글 42개, 댓글 102개, 답글 33개, 좋아요 219개, 싫어요 46개, 북마크 118개 |
| 카테고리별 게시글 | `notice`, `free`, `study`, `question`, `info`, `market`, `lost` 각 6개 |
| 생성 데이터 | 사용자, 카테고리별 게시글, 댓글/답글, 좋아요/싫어요, 북마크 |
| 데이터 구성 | 익명 게시글/댓글/답글, 다양한 작성일/수정일/조회수 포함 |
