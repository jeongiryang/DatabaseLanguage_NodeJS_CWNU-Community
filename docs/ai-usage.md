...
v1.2.0 작업에서는 ChatGPT와 Codex를 함께 사용하여 기능 단위 작업을 Issue/branch/commit/PR/merge 흐름으로 관리하고, 사용자가 최종 브라우저 화면과 배포 상태를 직접 확인하는 방식으로 진행함.
...
| 실제 사용자 개인정보 미사용 | seed 데이터에는 테스트용 `@cwnu.ac.kr` 이메일과 커뮤니티형 닉네임만 사용 |
